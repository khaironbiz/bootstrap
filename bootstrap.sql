...
CREATE TABLE `kabupaten` (
  ...
  `nama_kabupaten` tinytext COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `provinsi` (
  `id_prov` char(2) COLLATE utf8_unicode_ci NOT NULL,
  `nama_provinsi` tinytext COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `provinsi` (`id_prov`, `nama_provinsi`, `count_prov`) VALUES
('11', 'Aceh', 0),
('12', 'Sumatera Utara', 0),
('13', 'Sumatera Barat', 0),
('14', 'Riau', 0),
