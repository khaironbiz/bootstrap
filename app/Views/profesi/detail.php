                ...
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        <table class="table text-start">
                            <tr>
                                <td>Nama Organisasi</td><td>:</td><td><?= $profesi['nama_op']?></td>
                            </tr>
                            <tr>
                            <td>Ketua Organisasi</td><td>:</td><td><?= $profesi['ketua_op']?></td>
                            </tr>
                            <tr>
                            <td>Website</td><td>:</td><td><?= $profesi['web_op']?></td>
                            </tr>
                            <tr>
                                <td>Email</td><td>:</td><td><?= $profesi['email_op']?></td>
                            </tr>
                        </table>
                    </div>
                    <div class="card-footer">
                    <a href="<?= base_url('profesi')?>" class="btn btn-primary">Kembali</a>
                    <a href="<?= base_url('profesi/edit')."/".$profesi['has_profesi_kesehatan'];?>" class="btn btn-success">Edit</a>
                    <a href="<?= base_url('profesi/delete')."/".$profesi['has_profesi_kesehatan'];?>" class="btn btn-danger">Hapus</a>
                    </div>
                </div>
            </div>
        </div>
